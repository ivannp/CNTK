...
{
    static std::wstring tempModelPath = L"feedForward.net";
    ...
    CNTK::SaveAsLegacyModel<ElementType>(functionPtr, tempModelPath);
    functionPtr = CNTK::LoadLegacyModel<ElementType>(tempModelPath, device);
